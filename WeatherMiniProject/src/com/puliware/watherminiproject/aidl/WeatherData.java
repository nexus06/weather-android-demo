 ...
 * the WeatherService app. This POJO implements the Parcelable interface to
 * enable IPC between the WeatherActivity and the WeatherServiceSync and
 * WeatherServiceAsync. It represents the response Json obtained from the Open
 * Weather Map API, e.g., a call to
...
public class WeatherData implements Parcelable {
	 ...
	 * @param code
	 */
	public WeatherData(String name, double speed, double deg, double temp,
			long humidity, long sunrise, long sunset, long date, String icon,
			String description, long code, String message) {
		mName = name;
		mSpeed = speed;
		mDeg = deg;
		mTemp = temp;
	...
	public String toString() {
		return "WeatherData [name=" + mName + ", speed=" + mSpeed + ", deg="
				+ mDeg + ", temp=" + mTemp + ", humidity=" + mHumidity
				+ ", sunrise=" + mSunrise + ", sunset=" + mSunset + ", mDate="
				+ mDate + ", micon=" + mIcon + ", mDescription=" + mDescription
				+ "]";
	}
	...
	/**
	 * public Parcelable.Creator for WeatherData, which is an interface that
	 * must be implemented and provided as a public CREATOR field that generates
