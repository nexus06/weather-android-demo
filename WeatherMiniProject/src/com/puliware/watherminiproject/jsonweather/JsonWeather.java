 ...
 * downloaded in Json from the Weather Service. We don't care about all the
 * data, just the fields defined in this class.
 */
public class JsonWeather {
	/**
	 * Various tags corresponding to data downloaded in Json from the Weather
	 * Service.
	 */
	...
	/**
	 * Various fields corresponding to data downloaded in Json from the Weather
	 * Service.
	 */
	private Sys mSys;
	 ...
	 */
	public JsonWeather(Sys sys, String base, Main main, List<Weather> weather,
			Wind wind, long dt, long id, String name, long cod, String message) {
		mSys = sys;
		mBase = base;
		mMain = main;
		mWeather = weather;
